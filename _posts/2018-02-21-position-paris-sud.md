...
author: Paris-Sud
title: Open Position at Université Paris-Sud
tags:
    - job-opening
---

This is an announcement for a position opening at Université
...
Interviews in Spring 2018 for a recruitment as soon as possible until 
Fall 2019.
...
A successful candidate will be expected to contribute in particular to the following tasks of the OpenDreamKit project:
...
- Experience in the design and practical implementation of
  computational mathematics software (e.g.
  [SageMath](http://sagemath.org)), support systems (e.g, [Jupyter](http://jupyter.org/);

- Experience in open-source development (collaborative development
  tools, interaction with the community, ...);

- Experience in programming and markup languages such as Scala, Python, HTML, Javascript, etc.
...
u-psud.fr by March 15, with the following documents (in English) attached:
...
- degree.pdf: copy of your most recent degree including (if applicable) PhD reports;
