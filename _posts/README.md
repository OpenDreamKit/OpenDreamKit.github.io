 ...
 * **type** the type of activity *blogpost*, *talk*, *release*, *workshop*, *report*, *conference*, etc. Whatever you like basically, no specific rules
 * **date** the date *YYYY/MM/DD*
 * **redirect_from** not needed for new posts, this is just the redirect link from old activities pages on the former site
 * **tags** a list of tag. The available tags are in the folder */tag/* you can create news tags aby adding a page there and then adding the tag to your post.
