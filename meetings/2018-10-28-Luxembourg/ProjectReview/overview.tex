...
\begin{frame}[fragile]{Challenge: a rich variety of objects}
  \pause
...
\begin{frame}{\fr{Graphes}\en{Graphs}}
  \centerline{\includegraphics[width=.95\columnwidth]{Pictures/crystal-A3-32}}
\end{frame}
...
\begin{frame}{\fr{Objets géométriques}\en{Geometric objects}}
  ...
  \centerline{\includegraphics[height=.45\textheight]{Pictures/G2-alcove-path}\qquad
