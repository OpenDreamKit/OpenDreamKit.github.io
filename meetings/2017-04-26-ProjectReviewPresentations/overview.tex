...
\begin{frame}{Open Science getting momentum}
  ...
  \item Finally getting recognition as \textbf{viable} and \textbf{necessary},\\
    ...
    % Mike's talk will say more on why open source. 
    % Reproducibility has been identified centuries ago as at the
    % heart of Scientific process; without openness, there can't
    % be reproducibility.
  \end{itemize}
\end{frame}
...
% \item Support a large range of computational software/database stacks
