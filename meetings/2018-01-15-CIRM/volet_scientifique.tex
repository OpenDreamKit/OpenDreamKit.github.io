...
\item Keep the development efforts manageable as the size and
  complexity of software system increase;
...
\item Encourage people to get involved and contribute, especially
  young and women, in particular by exposing them with role models.
...
\item More advanced users that want to get an overview on the
  ecosystem, benefit for expert advice;
...
H2020-EINFRA-2015-1 call, that will be running for four years starting from
