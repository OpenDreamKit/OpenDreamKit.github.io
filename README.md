...
- tag: the tag pages, each tag gets an almost empty md file so that the tag page gets generated by jekyll
- meetings: our meeting content and pages, is accessible thoough not directely linked from anywhere on the site
